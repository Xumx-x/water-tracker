...
- **🖥️ 布局（v11.2）**：Gitee 风格——固定 48px 深色导航栏（#1f2733，z-index 900）+ 居中容器（max-width 1200px）+ hash 路由四页面 `#/home` `#/history` `#/forum` `#/settings`；历史页含近 30 天趋势图+内联历史列表；设置页含每日目标+数据导入导出；用户下拉菜单（设置入口）+独立退出按钮
